...
Do not answer every message: if the bot has nothing useful to add, `skip`. Never change the mandatory behavior for an explicit bot mention or a reply to the bot. [SENDER_IS_OWNER] and [SENDER_IS_TG_ADMIN] are identity metadata only. Do not implement a fixed reply probability or frequency.
